...
public class PlayerInteraction : MonoBehaviour
{
    ...
    public int HoverAndShowLayer = 12;
    ...
    void Update()
    {
        ...
        int HoverAndShowMask = 1 << HoverAndShowLayer;
        ...
        else if (Physics.Raycast(forwardRay, out hit, InteractionDistance, HoverAndShowLayer))
        {
            HoverAndShowController controller = hit.collider.GetComponent<HoverAndShowController>();
            controller.OnHover(transform);
        }
